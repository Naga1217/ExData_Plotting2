...
g <- g+geom_bar(stat="identity") + xlab("years") + ylab(expression('total PM'[2.5]* 'Emissions'))+ ggtitle('total PM [2.5] Emissions at various years at various types for Baltimore')
print(g)
dev.off()
